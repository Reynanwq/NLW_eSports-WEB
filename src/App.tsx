...
function App(){
    return(
        ...
        <div className="grid grid-cols-6 gap-6 mt-16">
            ...
            <div className="w-full pt-2 pb-4 px-4 bg-game-gradient bottom-0 left-0 right-0">
            ...
            <a href="relative rounded-lg overflow-hidden">
                ...
                <div className="w-full pt-2 pb-4 px-4 bg-game-gradient bottom-0 left-0 right-0">
                <strong className="font-bold text-white block overflow-hidden h-4 text-sm">Apex Legends</strong>
                <span className="text-zinc-300 text-sm block mt-1 overfolw">4 Anuncios</span>
            </div>
            </a>
            <a href="relative rounded-lg overflow-hidden">
        ...
        <div className="pt-1 bg-nlw-gradient self-stretch rounded-lg mt-8 overflow-hidden">
            ...
            <button className="py-3 px-4 bg-violet-500 hover:bg-violet-800 text-white rounded flex items-center gap-2">
